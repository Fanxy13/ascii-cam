...
const PALETTES = [
  ...
  { name: "Bubblegum",       colors: ["#3d1a35", "#7a2f66", "#c44f9e", "#ff85c8", "#ffd6ed"], bg: "#1f0d1b" },
  ...
  { name: "Duotone Red",     colors: ["#3d0b0b", "#731e1e", "#b53a3a", "#e07a7a", "#f7dcdc"], bg: "#1f0505" },
  { name: "Copper",          colors: ["#241108", "#5c2d14", "#a35228", "#d98452", "#f2c9a8"], bg: "#120804" },
  { name: "Bronze",          colors: ["#1f1608", "#4d3814", "#8a6524", "#c9973d", "#edd6a8"], bg: "#0f0b04" },
  { name: "Silver",          colors: ["#1c1f24", "#434a52", "#7b8794", "#b4bfca", "#f0f4f8"], bg: "#0e1013" },
  { name: "Gold",            colors: ["#241c00", "#5c4700", "#a37d00", "#e0b52e", "#fff0b8"], bg: "#120e00" },
  { name: "Emerald",         colors: ["#04130c", "#0b3d24", "#14805c", "#2ecc8f", "#b3ffe0"], bg: "#020a06" },
  { name: "Ruby",            colors: ["#1a0008", "#4d0019", "#99002e", "#e6004d", "#ff99bb"], bg: "#0d0004" },
  { name: "Sapphire",        colors: ["#00081a", "#001a4d", "#003399", "#3366ff", "#99b3ff"], bg: "#00040d" },
  { name: "Amethyst",        colors: ["#12061a", "#33144d", "#5c2899", "#9966ff", "#d6b3ff"], bg: "#09030d" },
