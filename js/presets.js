...
const PALETTES = [
  ...
  { name: "X-Ray",           colors: ["#0a0a12", "#1e2a4a", "#3d5a8a", "#8aa8d8", "#ffffff"], bg: "#050509" },
  { name: "Sonar",           colors: ["#00120c", "#00341f", "#00753f", "#00c853", "#a5ffcf"], bg: "#000806" },
  { name: "Infrared",        colors: ["#14000a", "#4a0020", "#a30040", "#ff3366", "#ffb3c6"], bg: "#0a0005" },
  { name: "Lava",            colors: ["#1a0500", "#5c1200", "#b32d00", "#ff6600", "#ffcc66"], bg: "#0d0200" },
  { name: "Glacier",         colors: ["#0a1a24", "#14405c", "#2e7da3", "#6dc5e0", "#e0f7ff"], bg: "#050d12" },
  { name: "Sakura",          colors: ["#3d1f2e", "#7a3b57", "#c26e8f", "#f7a8c4", "#ffe0ec"], bg: "#1f0f17" },
  { name: "Autumn",          colors: ["#2b1a0a", "#5c3a14", "#a3651f", "#e09b3d", "#ffd9a0"], bg: "#150d05" },
  { name: "Forest",          colors: ["#0d1f0d", "#1f4023", "#3d6b3d", "#6b9e5c", "#c4e0a8"], bg: "#061006" },
  { name: "Desert",          colors: ["#2e2418", "#5c4a30", "#997a4d", "#ccae7a", "#f2e2c4"], bg: "#171208" },
  { name: "Ocean",           colors: ["#001621", "#003554", "#006494", "#0582ca", "#a8dadc"], bg: "#000b10" },
  { name: "Sunset",          colors: ["#2b1b3d", "#6b2d5c", "#c94b6b", "#ff8a5c", "#ffd9a0"], bg: "#150d1e" },
  { name: "Aurora",          colors: ["#0b1026", "#1b3a5c", "#2ec4b6", "#7bf1a8", "#e0fff0"], bg: "#050814" },
  { name: "Nebula",          colors: ["#150a2e", "#3d1b6b", "#7b3fa8", "#c47ae0", "#f0d9ff"], bg: "#0a0519" },
  { name: "Neon",            colors: ["#0d0221", "#4a00e0", "#8e2de2", "#f72585", "#4cc9f0"], bg: "#060110" },
  { name: "Cyber",           colors: ["#0a0e17", "#1b3a4b", "#00d9ff", "#ff2a6d", "#d1f7ff"], bg: "#05080d" },
  { name: "Acid",            colors: ["#0f1a00", "#2e4d00", "#6b9e00", "#aaff00", "#e0ffb3"], bg: "#080d00" },
  { name: "Toxic",           colors: ["#0a1400", "#2b4d0a", "#5c9e14", "#9eff1f", "#d9ffa8"], bg: "#050a00" }
];
